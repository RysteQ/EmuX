namespace EmuX
{
    class Interrupt
    {
        ...
        public void SetInterruptCode(ulong interrupt_int_code)
        {
            ...
            {
                case 2:
                    this.interrupt_code = Interrupt_Codes.Set_Cursor_Position;
                    break;

                case 3:
                    this.interrupt_code = Interrupt_Codes.Get_Cursor_Position;
                    break;

                case 6:
                    this.interrupt_code = Interrupt_Codes.Clear_Screen;
                    break;

                case 8:
                    this.interrupt_code = Interrupt_Codes.Read_Character_At_Cursor_Position;
                    break;

                case 9:
                    this.interrupt_code = Interrupt_Codes.Write_Character_At_Cursor_Position;
                    break;

                case 12:
                    this.interrupt_code = Interrupt_Codes.Write_Pixel_At_Position;
                    break;

                case 15:
                    this.interrupt_code = Interrupt_Codes.Read_From_Disk;
                    break;

                case 16:
                    this.interrupt_code = Interrupt_Codes.Write_To_Disk;
                    break;

                case 92:
                    this.interrupt_code = Interrupt_Codes.Wait_Delay;
                    break;

                default:
                    this.interrupt_code = Interrupt_Codes.NoN;
                    break;
            }
        }
