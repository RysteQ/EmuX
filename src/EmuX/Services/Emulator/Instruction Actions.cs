...
namespace EmuX.Services.Emulator
{
    internal class Instruction_Actions
    {
        ...
        public VirtualSystem DIV(VirtualSystem virtual_system, Instruction_Data.Bit_Mode_ENUM bit_mode, ulong destination_value)
        {
            ...
            switch (bit_mode)
            {
                ...
                case Instruction_Data.Bit_Mode_ENUM._32_BIT:
                    divident = (virtual_system.GetRegisterDouble(Instruction_Data.Registers_ENUM.RDX) << 32) + virtual_system.GetRegisterDouble(Instruction_Data.Registers_ENUM.RAX);
