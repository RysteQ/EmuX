...
namespace EmuX.src.Services.Interrupt_Handler
{
    public class Disk_Handler
    {
        ...
        public VirtualSystem ReadFromDisk(Registers.Registers_ENUM first_register, Registers.Registers_ENUM second_register)
        {
            byte current_byte = 0;
            int offset = 0;
        ...
        public void WriteToDisk(Registers.Registers_ENUM first_register, Registers.Registers_ENUM second_register)
        {
            byte current_byte = 0;
            int offset = 0;
