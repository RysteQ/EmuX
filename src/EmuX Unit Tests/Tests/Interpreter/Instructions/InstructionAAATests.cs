...
public sealed class InstructionAAATests : InstructionConstants<InstructionAAA>
{
    ...
    {
        IInstruction instruction = GenerateInstruction(InstructionVariant.TwoOperandsMemoryRegister(), GenerateOperand("[test_label]", OperandVariant.Memory, Size.Byte, [], "test_label"), GenerateOperand("al", OperandVariant.Value, Size.Byte));
