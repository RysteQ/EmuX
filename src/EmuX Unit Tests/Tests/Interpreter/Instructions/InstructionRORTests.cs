...
[TestClass]
public sealed class InstructionRORTests : InstructionConstants<InstructionROR>
{
    [TestMethod]
    ...
    public void TestExecuteMethod_ShiftRegisterToRegister()
    {
        ...
        Assert.AreEqual<bool>(true, virtualMachine.GetFlag(EFlags.CF));
        Assert.AreEqual<byte>(0b_1001_0101, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AL);
    }
    ...
    public void TestExecuteMethod_ShiftMemoryToValue()
    {
        ...
        Assert.AreEqual<bool>(true, virtualMachine.GetFlag(EFlags.CF));
        Assert.AreEqual<byte>(0b_1001_0010, virtualMachine.GetByte(0));
    }
