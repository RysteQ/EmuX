...
[TestClass]
public sealed class InstructionXORTests : InstructionConstants<InstructionXOR>
{
    [TestMethod]
    ...
    public void TestExecuteMethod_VariantTwoOperandsRegisterValue()
    {
        ...
        Assert.AreEqual<ulong>(0b_0000_0000_0000_0000_0000_0000_0000_0000_0110_1001_1111_1111_1010_1010_1010_1010, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().RAX);
    ...
    public void TestExecuteMethod_VariantTwoOperandsRegisterRegister()
    {
        ...
        Assert.AreEqual<ulong>(0b_0000_0000_0000_0000_0000_0000_0000_0000_0110_1001_0000_1111_1010_1010_1010_1010, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().RAX);
        Assert.AreEqual<bool>(false, virtualMachine.GetFlag(EFlags.SF));
        Assert.AreEqual<bool>(false, virtualMachine.GetFlag(EFlags.ZF));
        Assert.AreEqual<bool>(true, virtualMachine.GetFlag(EFlags.PF));
    }
    ...
    public void TestExecuteMethod_VariantTwoOperandsMemoryValue()
    {
        ...
        Assert.AreEqual<ulong>(0b_0000_0000_0000_0000_0000_0000_0000_0000_0110_1001_1111_1111_1010_1010_1010_1010, virtualMachine.GetQuad(0));
        Assert.AreEqual<bool>(false, virtualMachine.GetFlag(EFlags.SF));
        Assert.AreEqual<bool>(false, virtualMachine.GetFlag(EFlags.ZF));
        Assert.AreEqual<bool>(true, virtualMachine.GetFlag(EFlags.PF));
    }
    ...
    public void TestExecuteMethod_VariantTwoOperandsMemoryRegister()
    {
        ...
        Assert.AreEqual<ulong>(0b_0000_0000_0000_0000_0000_0000_0000_0000_0110_1001_0000_1111_1010_1010_1010_1010, virtualMachine.GetQuad(0));
        Assert.AreEqual<bool>(false, virtualMachine.GetFlag(EFlags.SF));
        Assert.AreEqual<bool>(false, virtualMachine.GetFlag(EFlags.ZF));
        Assert.AreEqual<bool>(true, virtualMachine.GetFlag(EFlags.PF));
    }
