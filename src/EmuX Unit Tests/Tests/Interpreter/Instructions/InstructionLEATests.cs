...
public sealed class InstructionLEATests : InstructionConstants<InstructionLEA>
{
    ...
    {
        IInstruction instruction = GenerateInstruction(InstructionVariant.TwoOperandsRegisterMemory(), GenerateOperand("ecx", OperandVariant.Register, Size.Word), GenerateOperand("[eax * 4]", OperandVariant.Memory, Size.Word, [GenerateMemoryOffset(MemoryOffsetType.Register, MemoryOffsetOperand.Addition, "eax"), GenerateMemoryOffset(MemoryOffsetType.Scale, MemoryOffsetOperand.Multiplication, "4")])); // TODO
