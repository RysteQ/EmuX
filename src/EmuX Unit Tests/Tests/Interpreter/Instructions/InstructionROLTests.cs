...
[TestClass]
public sealed class InstructionROLTests : InstructionConstants<InstructionROL>
{
    [TestMethod]
    ...
    public void TestExecuteMethod_ShiftRegisterToValue()
    {
        ...
        Assert.AreEqual<byte>(0b_1100_1010, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AL);
    }
    ...
    public void TestExecuteMethod_ShiftRegisterToRegister()
    {
        ...
        Assert.AreEqual<byte>(0b_0110_0101, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AL);
    }
    ...
    public void TestExecuteMethod_ShiftMemoryToValue()
    {
        ...
        Assert.AreEqual<bool>(true, virtualMachine.GetFlag(EFlags.CF));
        Assert.AreEqual<byte>(0b_0010_1001, virtualMachine.GetByte(0));
    }
