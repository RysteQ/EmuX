...
[TestClass]
public sealed class InstructionNEGTests : InstructionConstants<InstructionNEG>
{
    [TestMethod]
    ...
    [TestMethod]
    public void TestExecuteMethod_NegateRegister()
    {
        ...
        Assert.AreEqual<byte>(0b_1111_1111, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AL);
    }

    [TestMethod]
    public void TestExecuteMethod_NegateMemory()
    {
        ...
        Assert.AreEqual<byte>(0b_0000_0000, virtualMachine.GetByte(0));
    }
}