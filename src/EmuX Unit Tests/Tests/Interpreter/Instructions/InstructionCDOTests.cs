...
[TestClass]
public sealed class InstructionCDOTests : InstructionConstants<InstructionCDO>
{
    [TestMethod]
    ...
    public void TestExecuteMethod_DoExtendSign()
    {
        ...
        virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().RAX = 0b_1000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000;
        virtualMachine.CPU.GetRegister<VirtualRegisterRDX>().RDX = 0;
        instruction.Execute(virtualMachine);

        Assert.AreEqual<ulong>(ulong.MaxValue, virtualMachine.CPU.GetRegister<VirtualRegisterRDX>().RDX);
    }
    ...
    public void TestExecuteMethod_DoNotExtendSign()
    {
        ...
        virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().RAX = 0b_0100_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000;
        virtualMachine.CPU.GetRegister<VirtualRegisterRDX>().RDX = ulong.MaxValue;
        instruction.Execute(virtualMachine);

        Assert.AreEqual<ulong>(0, virtualMachine.CPU.GetRegister<VirtualRegisterRDX>().RDX);
    }
}