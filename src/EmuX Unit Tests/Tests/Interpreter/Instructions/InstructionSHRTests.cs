...
[TestClass]
public sealed class InstructionSHRTests : InstructionConstants<InstructionSHR>
{
    [TestMethod]
    ...
    public void TestExecuteMethod_ShiftRegisterToValue()
    {
        ...
        Assert.AreEqual<byte>(0b_0000_1010, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AL);
    }
