...
[TestClass]
public sealed class InstructionMOVSWTests : InstructionConstants<InstructionMOVSW>
{
    [TestMethod]
    ...
    [TestMethod]
    public void TestExecuteMethod_IncrementRegisters_RSI_RDI()
    {
        IInstruction instruction = GenerateInstruction();
        ...
        Assert.AreEqual<ulong>(2, virtualMachine.CPU.GetRegister<VirtualRegisterRSI>().RSI);
        Assert.AreEqual<ulong>(2, virtualMachine.CPU.GetRegister<VirtualRegisterRDI>().RDI);
    }

    [TestMethod]
    public void TestExecuteMethod_DecrementRegisters_RSI_RDI()
    {
        IInstruction instruction = GenerateInstruction();
        IVirtualMachine virtualMachine = GenerateVirtualMachine();
