...
[TestClass]
public sealed class InstructionSHLTests : InstructionConstants<InstructionSHL>
{
    [TestMethod]
    ...
    public void TestExecuteMethod_ShiftRegisterToValue()
    {
        ...
        Assert.AreEqual<byte>(0b_1100_0000, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AL);
    }
    ...
    public void TestExecuteMethod_ShiftRegisterToRegister()
    {
        ...
        Assert.AreEqual<byte>(0b_0110_0000, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AL);
    }
    ...
    public void TestExecuteMethod_ShiftMemoryToValue()
    {
        ...
        Assert.AreEqual<bool>(true, virtualMachine.GetFlag(EFlags.CF));
        Assert.AreEqual<byte>(0b_0010_1000, virtualMachine.GetByte(0));
    }
    ...
    public void TestExecuteMethod_ShiftMemoryToRegister()
    {
        ...
        Assert.AreEqual<bool>(false, virtualMachine.GetFlag(EFlags.CF));
        Assert.AreEqual<byte>(0b_1001_0100, virtualMachine.GetByte(0));
    }
}