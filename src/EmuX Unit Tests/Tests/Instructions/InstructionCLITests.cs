...
public sealed class InstructionCLITests : InstructionConstants<InstructionCLI>
{
    ...
    public void TestExecuteMethod_ClearIFlah()
    {
        ...
        Assert.AreEqual(false, virtualMachine.GetFlag(EFlags.IF));
        Assert.AreEqual(true, virtualMachine.GetFlag(EFlags.VIF));
    }
    ...
    public void TestExecuteMethod_ClearVIFlah()
    {
        ...
        Assert.AreEqual(true, virtualMachine.GetFlag(EFlags.IF));
        Assert.AreEqual(false, virtualMachine.GetFlag(EFlags.VIF));
    }
}