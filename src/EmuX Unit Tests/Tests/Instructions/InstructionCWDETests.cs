...
[TestClass]
public sealed class InstructionCWDETests : InstructionConstants<InstructionCWDE>
{
    [TestMethod]
    ...
    public void TestExecuteMethod_DoNotExtendSign()
    {
        ...
        Assert.AreEqual(0b_1111_1111_1111_1111_1000_0000_0000_0000, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().EAX);
    }
}