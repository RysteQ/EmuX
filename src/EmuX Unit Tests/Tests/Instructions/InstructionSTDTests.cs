...
[TestClass]
public sealed class InstructionSTDTests : InstructionConstants<InstructionSTD>
{
    [TestMethod]
    ...
    [TestMethod]
    public void TestExecuteMethod_SetCFToTrue()
    {
        ...
        Assert.AreEqual<bool>(true, virtualMachine.GetFlag(EFlags.DF));
