...
[TestClass]
public sealed class InstructionLODSWTests : InstructionConstants<InstructionLODSW>
{
    [TestMethod]
    ...
    [TestMethod]
    public void TestExecuteMethod_IncrementESI()
    {
        IInstruction instruction = GenerateInstruction();
    ...
    [TestMethod]
    public void TestExecuteMethod_DecrementESI()
    {
        IInstruction instruction = GenerateInstruction();
        IVirtualMachine virtualMachine = GenerateVirtualMachine();
