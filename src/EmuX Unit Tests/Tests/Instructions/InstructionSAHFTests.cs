...
[TestClass]
public sealed class InstructionSAHFTests : InstructionConstants<InstructionSAHF>
{
    [TestMethod]
    ...
    [TestMethod]
    public void TestExecuteMethod_LoadAhIntoEflags_One()
    {
        IInstruction instruction = GenerateInstruction(InstructionVariant.NoOperands());
        IVirtualMachine virtualMachine = GenerateVirtualMachine();

        virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AH = 0b_1111_1111;
        virtualMachine.CPU.GetRegister<VirtualRegisterEFLAGS>().FLAGS = 0b_1111_1111_0000_0000;
    ...
    [TestMethod]
    public void TestExecuteMethod_LoadAhIntoEflags_Two()
    {
        IInstruction instruction = GenerateInstruction(InstructionVariant.NoOperands());
        IVirtualMachine virtualMachine = GenerateVirtualMachine();

        virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AH = 0b_0000_0000;
        virtualMachine.CPU.GetRegister<VirtualRegisterEFLAGS>().FLAGS = 0b_1111_1111_1111_1111;
        instruction.Execute(virtualMachine);
