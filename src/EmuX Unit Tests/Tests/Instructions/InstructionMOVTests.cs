...
[TestClass]
public sealed class InstructionMOVTests : InstructionConstants<InstructionMOV>
{
    [TestMethod]
    ...
    {
        IInstruction instruction = GenerateInstruction(InstructionVariant.TwoOperandsRegisterValue(), GeneratePrefix(), GenerateOperand("rax", OperandVariant.Register, Size.Qword), GenerateOperand("40", OperandVariant.Value, Size.Byte));
        IVirtualMachine virtualMachine = GenerateVirtualMachine();

        virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().RAX = 0;
        instruction.Execute(virtualMachine);

        Assert.AreEqual<ulong>(40, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().RAX);
    }
    ...
    public void TestExecuteMethod_VariantTwoOperandsRegisterRegister()
    {
        ...
        Assert.AreEqual<ulong>(20, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().RAX);
    }

    [TestMethod]
    public void TestExecuteMethod_VariantTwoOperandsRegisterMemory()
    {
        IInstruction instruction = GenerateInstruction(InstructionVariant.TwoOperandsRegisterMemory(), GeneratePrefix(), GenerateOperand("rax", OperandVariant.Register, Size.Qword), GenerateOperand("[test_label]", OperandVariant.Memory, Size.Byte, [GenerateMemoryOffset(MemoryOffsetType.Label, MemoryOffsetOperand.NaN, "test_label")]));
        IVirtualMachine virtualMachine = GenerateVirtualMachine();
        ...
        Assert.AreEqual<ulong>(100, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().RAX);
    }
    ...
    public void TestExecuteMethod_VariantTwoOperandsMemoryValue()
    {
        ...
        Assert.AreEqual<ulong>(0x_10, virtualMachine.GetQuad(0));
    }

    [TestMethod]
    public void TestExecuteMethod_VariantTwoOperandsMemoryRegister()
    {
        IInstruction instruction = GenerateInstruction(InstructionVariant.TwoOperandsMemoryValue(), GeneratePrefix(), GenerateOperand("[test_label]", OperandVariant.Memory, Size.Qword, [GenerateMemoryOffset(MemoryOffsetType.Label, MemoryOffsetOperand.NaN, "test_label")]), GenerateOperand("rax", OperandVariant.Register, Size.Qword));
        IVirtualMachine virtualMachine = GenerateVirtualMachine();
        ...
        Assert.AreEqual<ulong>(16, virtualMachine.GetQuad(0));
    }
}