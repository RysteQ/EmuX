...
[TestClass]
public sealed class InstructionCBWTests : InstructionConstants<InstructionCBW>
{
    [TestMethod]
    ...
    public void TestExecuteMethod_DoNotExtendSign()
    {
        ...
        virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AL = 0b_0111_0000;
        instruction.Execute(virtualMachine);

        Assert.AreEqual<ushort>(0b_0000_0000_0111_0000, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AX);
    }
    ...
    public void TestExecuteMethod_DoExtendSign()
    {
        ...
        Assert.AreEqual(ushort.MaxValue, virtualMachine.CPU.GetRegister<VirtualRegisterRAX>().AX);
    }
}