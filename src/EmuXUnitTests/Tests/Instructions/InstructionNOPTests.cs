...
[TestClass]
public sealed class InstructionNOPTests : InstructionConstants<InstructionNOP>
{
    [TestMethod]
    ...
    [TestMethod]
    public void TestExecuteMethod_Nothing()
    {
        IInstruction instruction = GenerateInstruction(InstructionVariant.NoOperands(), GeneratePrefix());
