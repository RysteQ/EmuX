...
public static class DIFactory
{
    ...
    public static IVirtualMemory GenerateIVirtualMemory(uint ioMemory, uint generalPurposeMemory, IVirtualMachine? parentVirtualMachine = null) => new VirtualMemory(ioMemory, generalPurposeMemory, parentVirtualMachine);
