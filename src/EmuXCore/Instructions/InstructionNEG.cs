...
public sealed class InstructionNEG(InstructionVariant variant, IOperand? firstOperand, IOperand? secondOperand, IOperand? thirdOperand, IOperandDecoder operandDecoder, IFlagStateProcessor flagStateProcessor) : IInstruction
{
    public void Execute(IVirtualMachine virtualMachine)
    {
        if (FirstOperand.Variant == OperandVariant.Register)
        {
            ...
            switch (FirstOperand.OperandSize)
            {
                ...
                case Size.Double: register!.Set((0x_00_00_00_00_00_00_00_80 & (~(0x_00_00_00_00_80_00_00_00 & register!.Get()))) + (0x_0f_ff_ff_ff_7f_ff_ff_ff & register!.Get())); break;
                case Size.Quad: register!.Set((0x_00_00_00_00_00_00_00_80 & (~(0x_80_00_00_00_00_00_00_00 & register!.Get()))) + (0x_7f_ff_ff_ff_ff_ff_ff_ff & register!.Get())); break;
            }
        }
        else
        {
            switch (FirstOperand.OperandSize)
            {
                ...
                case Size.Double: virtualMachine.SetDouble(OperandDecoder.GetPointerMemoryAddress(virtualMachine, FirstOperand), (uint)((0x_80_00_00_00 & (~(0x_80_00_00_00 & virtualMachine.GetByte(OperandDecoder.GetPointerMemoryAddress(virtualMachine, FirstOperand))))) + (0x_7f_ff_ff_ff & virtualMachine.GetByte(OperandDecoder.GetPointerMemoryAddress(virtualMachine, FirstOperand))))); break;
                case Size.Quad: virtualMachine.SetQuad(OperandDecoder.GetPointerMemoryAddress(virtualMachine, FirstOperand), (ulong)((0x_80_00_00_00_00_00_00_00 & (~(0x_80_00_00_00_00_00_00_00 & virtualMachine.GetByte(OperandDecoder.GetPointerMemoryAddress(virtualMachine, FirstOperand))))) + (ulong)(0x_7f_ff_ff_ff_ff_ff_ff_ff & virtualMachine.GetByte(OperandDecoder.GetPointerMemoryAddress(virtualMachine, FirstOperand))))); break;
            }
        }
